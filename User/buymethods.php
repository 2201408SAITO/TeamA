...
<div v-if="acitiveWordsTab" class="field">
  ...
  <table class="table is-bordered">
    ...
    <tr>
      <td>クレジットカード有効期限</td>
      <td><input type="text"placeholder="2桁の数字で入力" style="outline:none; border-color:seagreen;width: 150px;"value="<?php echo htmlspecialchars($_SESSION['credit_card'][$user]['expiry_month']); ?>"class="input is-normal"name=""required pattern="^[0-9]{2,2}$">月 <input type="text"placeholder="4桁の数字で入力" style="outline:none; border-color:seagreen;width: 180px;"value="<?php echo htmlspecialchars($_SESSION['credit_card'][$user]['expiry_year']); ?>"class="input is-normal" required pattern="^[0-9]{4,4}$">年</td>
    </tr>
    <tr>
      <td>セキュリティコード</td>
